...
export default function Transactions() {
    ...
    }, [start, end, categoryFilter, emotionFilter, rowsPerPage]);
                    ...
                    <TableBody>
                            {rows.map(r => (
                                <TableRow key={r.id}>
                                    ...
                                    <TableCell align='right' style={{ color: parseFloat(String(r.value)) < 0 ? 'red' : 'green' }}>
                                        {parseFloat(String(r.value.toFixed(2)))}
                                    </TableCell>
